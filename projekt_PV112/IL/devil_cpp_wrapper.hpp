...
public:
	...
	static ILconst_string	GetString(ILenum);
...
{
public:
	static void				Check(void (*Callback)(ILconst_string));
	static void				Check(void (*Callback)(ILenum));
	static ILenum			Get(void);
	static ILconst_string	String(void);
	static ILconst_string	String(ILenum);
...
ILconst_string ilState::GetString(ILenum StringName)
{
...
// ILERROR
//
void ilError::Check(void (*Callback)(ILconst_string))
{
	static ILenum Error;
...
ILconst_string ilError::String()
{
	return iluErrorString(ilGetError());
}

ILconst_string ilError::String(ILenum Error)
{
